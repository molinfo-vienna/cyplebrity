...
LABEL org.opencontainers.image.source="https://github.com/molinfo-vienna/cyplebrity"
...
RUN apt-get update -y && apt-get install curl git build-essential -qq
