Feature: Consistent predictions
  ...
  Scenario Outline: Predictions stay consistent with previous versions
    ...
    And the value in column 'input' should be '<input_smiles>'
    And the value in column 'prediction_1' should be '<prediction_1>'
    And the value in column 'neighbor_1' should be '<neighbor_1>'
    And the value in column 'prediction_2' should be '<prediction_2>'
    And the value in column 'neighbor_2' should be '<neighbor_2>'
    And the value in column 'prediction_3' should be '<prediction_3>'
    And the value in column 'neighbor_3' should be '<neighbor_3>'
    And the value in column 'prediction_4' should be '<prediction_4>'
    And the value in column 'neighbor_4' should be '<neighbor_4>'
    And the value in column 'prediction_5' should be '<prediction_5>'
    And the value in column 'neighbor_5' should be '<neighbor_5>'
